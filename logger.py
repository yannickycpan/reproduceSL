...
class logger:
    ...
    def log_error_discrete(self, predict, mydatabag, final_log=False):
        # if final_log:
        predictions = predict(mydatabag.x_train)
        trainacc = classify_error(mydatabag.y_train, predictions, True)
        self.error_dict['train'].append(trainacc)

        predictions = predict(mydatabag.x_test)
        testacc = classify_error(mydatabag.y_test, predictions, True)
        self.error_dict['test'].append(testacc)
